<?php
 ...
 $qmahasiswa = "select mahasiswa.nama_lengkap, mahasiswa.alamat, kelas.nama AS nama_kelas from mahasiswa INNER JOIN kelas ON mahasiswa.kelas_id=kelas.kelas_id";
 $data_mahasiswa = $conn->query($qmahasiswa); 
$total_mahasiswa = $data_mahasiswa->num_rows;
$qselect_mahasiswa = "select mahasiswa.nama_lengkap, mahasiswa.alamat, kelas.nama AS nama_kelas from mahasiswa INNER JOIN kelas ON mahasiswa.kelas_id=kelas.kelas_id";
